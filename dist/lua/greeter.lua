...
local default_header = {
    ...
    val = {
        ...
        [[| . ` || | | | / _` || '_ \  / _ \ \ \ / /| || '_ ` _ \ | |]],
        [[| |\  || |_| || (_| || | | || (_) | \ V / | || | | | | ||_|]],
        [[\_| \_/ \__, | \__,_||_| |_| \___/   \_/  |_||_| |_| |_|(_)]],
        [[         __/ |                                             ]],
        [[        |___/                                              ]],
    },
    opts = {
...
local section = {
    ...
    top_buttons = {
        ...
        val = {
            ...
            button('f', 'File Explorer', '<cmd>NvimTreeToggle<cr>')
        },
    },
    ...
    mru = {
        ...
        val = {
            { type = "padding", val = 1 },
            { type = "text", val = "Recent (All Directories)", opts = { hl = "SpecialComment", position = 'center' } },
            { type = "padding", val = 1 },
            {
                type = "group",
                val = function()
